...
export async function POST(req: Request) {
  ...
  const candidateContext = [
    ...
    'Open-source developer-tooling project: building FirstTrace, a self-hosted bug-localization tool with a TypeScript CLI, read-only local/GitHub repository investigation, deterministic evidence search and ranking, optional OpenAI reasoning over bounded evidence, citations, evals, Slack Events handling, GitHub App repository access, filesystem/Supabase queues, Vercel-compatible receivers, and worker execution. Treat it as a real current open-source project, not as a production SaaS with customer adoption.',
